...
GoogleMerchant.configure do |config|
  ...
  # File path where feed will be generated by rake task. Path is relative to 
  # your application's public directory:
  config.feed_path = "google_merchant"
  
  # Format for file which will be generated by rake task. Will be added to file 
  # name taken from feed_path:
  config.feed_format = "atom"
